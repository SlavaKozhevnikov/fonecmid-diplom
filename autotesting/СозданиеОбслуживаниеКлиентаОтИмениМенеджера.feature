...
* Выбираю в поле "Клиент" контрагента
	...
	Если таблица  "Список" не содержит строки Тогда
		...
		И в поле с именем 'Наименование' я ввожу текст 'ООО \"Синяя птица\"'
...
* Выбираю в поле "Специалист" специалиста
	И из выпадающего списка с именем "Специалист" я выбираю точное значение 'Сидоров Сидор'
* Выбираю в поле "Договор" договор
	...
	Если таблица  "Список" не содержит строки Тогда
		...
		И из выпадающего списка с именем "Владелец" я выбираю точное значение 'ООО "Синяя птица"'
		И из выпадающего списка с именем "Организация" я выбираю точное значение 'ООО "Красная пилюля для Нео"'
...
* Выбираю в поле "Клиент" контрагента	
	...
	Если таблица  "Список" не содержит строки Тогда
		| 'Наименование'              |
		| 'ООО \"Под небом голубым\"' |
		И я нажимаю на кнопку с именем 'ФормаСоздать'
		Тогда открылось окно 'Контрагент (создание)'
		И в поле с именем 'Наименование' я ввожу текст 'ООО \"Под небом голубым\"'
...
* Выбираю в поле "Договор" договор	
	...
	Если таблица  "Список" не содержит строки Тогда
		...
		И из выпадающего списка с именем "Владелец" я выбираю точное значение 'ООО "Под небом голубым"'
		И из выпадающего списка с именем "Организация" я выбираю точное значение 'ООО "Красная пилюля для Нео"'
		И из выпадающего списка с именем "ВидДоговора" я выбираю точное значение 'Абоненское обслуживание'
		И я нажимаю кнопку выбора у поля с именем "ПериодДействияС"
		И в поле с именем 'ПериодДействияС' я ввожу текст '01.04.2025'
...
* Выбираю в поле "Клиент" контрагента		
	...
	Если таблица  "Список" не содержит строки Тогда
		| 'Наименование'             |
		| 'ООО \"Фиолетово-Черный\"' |
		И я нажимаю на кнопку с именем 'ФормаСоздать'
		Тогда открылось окно 'Контрагент (создание)'
		И в поле с именем 'Наименование' я ввожу текст 'ООО \"Фиолетово-Черный\"'
...
* Выбираю в поле "Договор" договор		
	...
	Если таблица  "Список" не содержит строки Тогда
		...
		И из выпадающего списка с именем "Владелец" я выбираю точное значение 'ООО "Фиолетово-Черный"'
		И из выпадающего списка с именем "Организация" я выбираю точное значение 'ООО "Красная пилюля для Нео"'
		И из выпадающего списка с именем "ВидДоговора" я выбираю точное значение 'Абоненское обслуживание'
		И я нажимаю кнопку выбора у поля с именем "ПериодДействияС"
		И в поле с именем 'ПериодДействияС' я ввожу текст '01.04.2025'
...
* Заполняю поле "ВремяОкончанияРаботПлан"
	И в поле с именем 'ВремяОкончанияРабот' я ввожу текст '13:00:00'
* Заполняю поле "ОписаниеПроблемы"		
	И в поле с именем 'ОписаниеПроблемы' я ввожу текст 'Надо помочь ребятам'
* Заполняю поле "Комментарий"	
	И в поле с именем 'Комментарий' я ввожу текст 'Ребята очень крутые'
	И я нажимаю на кнопку с именем 'ФормаЗаписать'
	Тогда открылось окно 'Обслуживание клиента * от *'
	И Я закрываю окно 'Обслуживание клиента * от *'
* Тогда в форме списка документов "Обслуживания клиентов" появились новые записи документов	
	И таблица "Список" содержит строки по шаблону:
		...
		| '**.**.2025 **:**:**' | 'ООО \"Синяя птица\"'       | 'Сидоров Сидор' | '000000*' | '№ 10 Сервисного обслуживания' | '07.04.2025'            |
		| '**.**.2025 **:**:**' | 'ООО \"Под небом голубым\"' | 'Сидоров Сидор' | '000000*' | '№ 11 Сервисного обслуживания' | '08.04.2025'            |
		| '**.**.2025 **:**:**' | 'ООО \"Фиолетово-Черный\"'  | 'Сидоров Сидор' | '000000*' | '№ 12 Сервисного обслуживания' | '09.04.2025'            |
